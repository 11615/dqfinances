...
//      $("#edit").modal("show");
//      $.ajax({
//        url:'<php echo base_url().'index.php/DashboardController/showEditForm'?>',
//        type: 'POST',
//        data:{ },
//        dataType: 'json',
...
//    $.ajax({
//     url:'<php echo base_url().'index.php/DashboardController/savemodel'?>',
//        type: 'POST',
...
//            }
//            if(response["message"] != ""){
//              $(".messageError").html(response["message"]).addClass('invalid-feedback d-block');
