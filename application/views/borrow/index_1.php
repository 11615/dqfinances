...
<!-- Mirrored from jituchauhan.com/borrow/borrow/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Nov 2021 03:55:48 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="slider-captions">
                        ...
                        <p class="slider-text d-none d-xl-block d-lg-block d-sm-block">The low rate you need for the need you want! Call
                            <br> (555) 123-4567</p>
                        <a href="loan_listing_image" class="btn btn-secondary">get started today</a>
                    </div>
                    <!-- /.slider-captions -->
                </div>
            </div>
                ...
                <div class="container">
                    <div class=" col-xl-6 col-lg-6 col-md-12  col-sm-12 col-12">
                        <div class="slider-captions">
                            ...
                            <a href="loan_listing_image" class="btn btn-secondary ">View Products</a>
                        </div>
                        <!-- /.slider-captions -->
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="service-img-box mb30 text-center outline">
                        <div class="service-img">
                            <a href="personal_loan" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-img.jpg" alt="Borrow - Loan Company Website Template " class="img-fluid"></a>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="service-img-box mb30 text-center outline">
                        <div class="service-img">
                            <a href="home_loan" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-img-1.jpg" alt="Borrow - Loan Company Website Template " class="img-fluid"></a>
                        </div>
                        <div class="service-content bg-white pinside30">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="service-img-box mb30 text-center outline">
                        <div class="service-img">
                            <a href="education_loan" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-img-2.jpg" alt="Borrow - Loan Company Website Template " class="img-fluid"></a>
                        </div>
                        <div class="service-content bg-white pinside30">
    ...
    <div class="bg-white section-space80">
        <div class="container">
            ...
            <div class="row">
                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 offset-md-2 col-md-8 col-sm-12 col-12 text-center mt30"> <a href="#!" class="btn btn-secondary">Find your rate</a> </div>
            </div>
        </div>
    </div>
    <div class="cta">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="number-block text-white">
                        ...
                        <h3 class="text-white mb10">Dedicated Specialists</h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="number-block text-white">
                        ...
                        <h3 class="text-white mb10">No Front Appraisal Fees!</h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="number-block text-white">
                        ...
                        <h3 class="text-white mb10">Success Stories Rating</h3>
    ...
    <div class="section-space40 bg-white">
        <div class="container">
            <div class="row">
                <div class="col-md-2 col-sm-4 col-6"> <img src="<?php echo base_url();?>asset/images/logo-1.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-md-2 col-sm-4 col-6"> <img src="<?php echo base_url();?>asset/images/logo-2.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-md-2 col-sm-4 col-6"> <img src="<?php echo base_url();?>asset/images/logo-3.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-md-2 col-sm-4 col-6"> <img src="<?php echo base_url();?>asset/images/logo-4.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-md-2 col-sm-4 col-6"> <img src="<?php echo base_url();?>asset/images/logo-5.jpg" alt="Borrow - Loan Company Website Template"> </div>
                <div class="col-md-2 col-sm-4 col-6"> <img src="<?php echo base_url();?>asset/images/logo-1.jpg" alt="Borrow - Loan Company Website Template"> </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="post-block mb30">
                        <div class="post-img">
                            <a href="blog_single" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-img.jpg" alt="Borrow - Loan Company Website Template" class="img-fluid"></a>
                        </div>
                        <div class="bg-white pinside40 outline">
                            <h3><a href="blog_single" class="title">Couples are Happy with Buying New Home Loan</a></h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="post-block mb30">
                        <div class="post-img">
                            <a href="blog_single" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-img-1.jpg" alt="Borrow - Loan Company Website Template" class="img-fluid"></a>
                        </div>
                        <div class="bg-white pinside40 outline">
                            <h3><a href="blog_single" class="title">Bigger Home Still The Goal Lorem Ipsum</a></h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="post-block mb30">
                        <div class="post-img">
                            <a href="blog_single" class="imghover"><img src="<?php echo base_url();?>asset/images/blog-img-2.jpg" alt="Borrow - Loan Company Website Templates" class="img-fluid"></a>
                        </div>
                        <div class="bg-white pinside40 outline">
                            <h3><a href="blog_single" class="title">Are you students looking for loan ?</a></h3>
                            <p class="meta"><span class="meta-date">Aug 24, 2017</span><span class="meta-author">By<a href="#!"> Admin</a></span></p>
                        </div>
                    </div>
                </div>
